...
log_file <- file(paste0(outDir, "log.txt"), open = "wt")

# Set up multi-output sink
...
library(snow)
source("Functions.R")
##Path for monthly mean temperature from CRUv4.09
tmp.path <- "Data/cru_ts4.09.1901.2024.tmp.dat.nc"

##Path for mean monthly maximum from CRUv4.03
tmx.path <- "Data/cru_ts4.09.1901.2024.tmx.dat.nc"
...
##Read in tmax data
tmx <- stack(paste0(dataDir,"cru_ts4.09.1901.2024.tmx.dat.nc"),varname = "tmx")
...
print(st2 - st1) # Time difference of 53.3123 mins
